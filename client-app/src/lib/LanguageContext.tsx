...
export const translations: Translations = {
    ...
    brands: { AR: "الوكالات", EN: "Agencies" },
    addBrand: { AR: "إضافة وكالة", EN: "Add Agency" },
    brandName: { AR: "اسم الوكالة", EN: "Agency Name" },
    brandLogo: { AR: "شعار الوكالة", EN: "Agency Logo" },
    brandCategory: { AR: "تصنيف الوكالة", EN: "Agency Category" },
    brandCars: { AR: "معرض السيارات", EN: "Car Showroom" },
    brandParts: { AR: "قطع الغيار", EN: "Spare Parts" },
    brandBoth: { AR: "كلاهما", EN: "Both" },
